...
const Leasing = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/sme/borrow/leasing by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:41:43 GMT */}
        <meta name="title" content="Leasing for SMEs | MCB	" />
        <meta
          name="description"
        ...
        />
        <title>Leasing for SMEs | MCB</title>
        <meta property="og:title" content="Leasing for SMEs | MCB" />
        <meta
      ...
      <div className="body detail-landing">
        ...
        <div role="main" className="main">
          <section
            ...
            style={{
              backgroundImage:
                "url(/images/mcb/sme/banners/sme-leasing0ea7.jpeg?sfvrsn=6963e7b6_1)",
            }}
          >
              ...
              <div className="row d-flex">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#ffffff" }}
                  >
                    Get high quality lease financing solutions from our industry
                    experts while maintaining your business edge.
                  </p>
                </div>
            ...
            >
              ...
              >
                <div className="check-ul-styling">
                  <div>
                    <h2>
                      A wide range of lease options for various industries
                    </h2>
                    <p>
                      With more than 15 years of experience, MCB Leasing is a
                      member of MCB Group and one of Mauritius’ most trusted
                      leasing companies. Together with a comprehensive set of
                      products and competitive lease rates, MCB Leasing has a
                      network of specialists who customise innovative solutions
                      and provide expert advice for your equipment leasing
                      needs.
                    </p>
                    <div>
                      <br />
                    ...
                    <ul>
                      <li>
                        Vehicles including passenger cars, vans, trucks and
                        buses
                      </li>
                      <li>Agricultural and earthmoving equipment</li>
                      <li>Industrial and textile equipment</li>
                      <li>IT and printing equipment</li>
                    </ul>
                    <h3>
                      <br />
                      Attractive MCB leasing solutions
                    </h3>
                    <ul>
                      <li>
      ...
      {/* Mirrored from mcb.mu/sme/borrow/leasing by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:41:50 GMT */}
    </>
  );
};
