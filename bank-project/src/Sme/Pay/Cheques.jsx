...
const Cheque = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/sme/pay/cheques by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:43:30 GMT */}
        <meta
          name="title"
          content="Foreign Currency Cheques | MCB SME Banking	"
        />
        <meta
          name="description"
        ...
        />
        <title>Foreign Currency Cheques | MCB SME Banking</title>
        <meta
          property="og:title"
          content="Foreign Currency Cheques | MCB SME Banking"
        />
      ...
      <div className="body detail-landing">
        ...
        <div role="main" className="main">
          <section
            ...
            style={{
              backgroundImage:
                "url(/images/mcb/sme/banners/sme-chequesd914.jpeg?sfvrsn=51499e71_1)",
            }}
          >
              ...
              <div className="row d-flex">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#ffffff" }}
                  >
                    Our processing services are tailored to your business needs;
                    through them, access your funds quickly and securely from
            ...
            >
              ...
              >
                <div className="check-ul-styling">
                  <div>
                    <h2>Send and receive money worldwide</h2>
                    <p>
                      If you need to cash a foreign currency cheque from an
                      overseas bank, we can help you clear it within a fast
                      turnaround time. Foreign currency cheques or overseas
                      banker&#39;s drafts are processed, depending on whether
                      you choose if we “negotiate” it or “collect” it.
                    </p>
                    <h3>
                      <br />
                      Negotiated Cheques
                    ...
                    <ul>
                      <li>
                        We buy the cheque from you by paying you the amount of
                        the cheque and the funds are then credited to your
                        account. However, the funds will be recalled from your
                        account if the paying bank returns the cheque as unpaid.
                      </li>
                    </ul>
                    <h3>
                      <br />
                    ...
                    <ul>
                      <li>
                        The cheque is sent on your behalf to the paying bank,
                        whereby the amount of the cheque is paid by us into your
                        account on the day we receive the funds from the paying
                        bank.
                      </li>
                    </ul>
                    <p>
                      <br />
                      As the leading bank in Mauritius, we offer competitive
                      exchange rates and charges for issuing and depositing
                      foreign currency cheques and banker’s drafts. In this
                      volatile economic environment, our SME banking experts
                      ensure you manage your business more efficiently, whilst
                      mitigating the various risks that your business may face
                      on a daily basis.
                    </p>
                  </div>
                </div>
      ...
      {/* Mirrored from mcb.mu/sme/pay/cheques by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:43:34 GMT */}
    </>
  );
};
