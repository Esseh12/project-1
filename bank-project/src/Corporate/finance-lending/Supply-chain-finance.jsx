...
const SupplyChainFinance = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/corporate/finance-lending/supply-chain-finance by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:51:01 GMT */}
        <meta
          name="title"
          content="Supply Chain Finance Solutions  | Corporate Banking | MCB	"
        />
        <meta
          name="description"
          content="Enhance trade operations, boost payment security, and explore new markets with MCB's supply chain finance solutions."
        />
        <title>Supply Chain Finance Solutions | Corporate Banking | MCB</title>
        <meta
          property="og:title"
          content="Supply Chain Finance Solutions  | Corporate Banking | MCB"
        />
      ...
      <div className="body detail-landing">
        ...
        <div role="main" className="main">
          <section
            ...
            style={{
              backgroundImage:
                "url(/images/mcb/corporate/banners/corporate-supply-chain-finance6734.jpeg?sfvrsn=94d7b4dd_1)",
            }}
          >
              ...
              <div className="row d-flex">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#ffffff" }}
                  >
                    Benefit from our range of products and services to enhance
                    your trade operations and increase security of payment.
                  </p>
                </div>
      ...
      {/* Mirrored from mcb.mu/corporate/finance-lending/supply-chain-finance by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:51:02 GMT */}
    </>
  );
};
