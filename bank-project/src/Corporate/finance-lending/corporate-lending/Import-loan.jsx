...
const ImportLoan = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/corporate/finance-lending/corporate-lending/import-loan by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:50:59 GMT */}
        <meta name="title" content="Import Loan | Corporate Banking | MCB	" />
        <meta
          name="description"
          content="Access quick, flexible import financing solutions to confidently manage your trade transactions with MCB's support and expertise."
        />
        <title>Import Loan | Corporate Banking | MCB</title>
        <meta
          property="og:title"
          content="Import Loan | Corporate Banking | MCB"
        />
        <meta
      ...
      <div className="body detail-landing">
        ...
        <div role="main" className="main">
          <section
            ...
            style={{
              backgroundImage:
                "url(/images/mcb/corporate/banners/corporate-import-loanbed2.jpeg?sfvrsn=724dff52_1)",
            }}
          >
              ...
              <div className="row d-flex">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#ffffff" }}
                  >
                    Trade with confidence and benefit from the experience and
            ...
            >
              ...
              >
                <div className="check-ul-styling">
                  <div>
                    <h2>A flexible bridging short term financing</h2>
                    <p>
                      Access immediate financing for timely payment to your
                      suppliers while awaiting proceeds from your buyers.
                      Channel your request to your dedicated Relationship
                      Manager, who will provide you with solutions to meet your
                    ...
                    <p>
                      ...
                      specialists who will provide you flexible import line
                      facility to respond to your company’s working capital
                      requirements:
                    </p>
                    <ul>
                      <li>
                      ...
                      <li>
                        Flexible funding of an agreed limit to cover short-term
                        needs and easy to arrange
                      </li>
                      <li>
                        Boost your company’s funding require to effect timely
                        payment to your supplier to grow your business
                      </li>
                    </ul>
                  </div>
                </div>
