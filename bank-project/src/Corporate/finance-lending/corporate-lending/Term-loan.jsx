...
const TermLoan = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/corporate/finance-lending/corporate-lending/term-loan by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:51:00 GMT */}
        <meta name="title" content="Term Loan" />
        <title>Term Loan</title>{" "}
        <meta property="og:title" content="Term Loan" />
        <meta
          property="og:url"
      ...
      <div className="body detail-landing">
        ...
        <div role="main" className="main">
          <section
            ...
            style={{
              backgroundImage:
                "url(/images/mcb/corporate/banners/corporate-term-loan3a0a.jpeg?sfvrsn=b318889e_1)",
            }}
          >
              ...
              <div className="row d-flex">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#ffffff" }}
                  >
                    Flexible financing solutions customised to your specific
                    business needs coupled with a team of experienced bankers
            ...
            >
              ...
              >
                <div className="check-ul-styling">
                  <div>
                    <h2>Flexible financing with a personalised approach</h2>
                    <p>
                      At MCB, our corporate banking specialists provide with
                      flexible financing solutions tailored to your business
                      requirements over an agreed term and with competitive
                      features and repayment structure.
                    </p>
                    <h3>
                      <br />
                    ...
                    <p>
                      From purchasing long-term assets to raising funds for your
                      business expansion projects, our proven specialists work
                      alongside you to put together the ideal financing solution
                      tailored to your business needs while enhancing your cash
                      flow.
                    </p>
                    <ul>
                      <li>
                        Flexible repayment terms that best suit your cash flow
                        profile
                      </li>
                      <li>
                        A dedicated team of experienced Relationship Managers to
