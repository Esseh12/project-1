...
const ToolsHowMuchCanIBorrow = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/tools-calculators/how-much-can-i-borrow by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 07:10:51 GMT */}
                  ...
                  <ul className="nav nav-tabs justify-content-start">
                    <li className="nav-item">
                      <a
                        ...
                        href="how-much-can-i-borrow/index.html"
                        tabIndex={-1}
                      >
                    ...
                    <li className="nav-item active" role="presentation">
                      <a
                        className="nav-link "
                        href="monthly-repayment/index.html"
                      >
                        Monthly Repayment
                      </a>
                    </li>
      ...
      {/* Mirrored from mcb.mu/tools-calculators/how-much-can-i-borrow by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 07:13:07 GMT */}
    </>
  );
};
export default ToolsHowMuchCanIBorrow;
