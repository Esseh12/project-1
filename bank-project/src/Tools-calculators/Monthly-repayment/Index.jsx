...
const MonthlyIndex = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/tools-calculators/monthly-repayment/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:55:16 GMT */}
        <meta name="title" content="Monthly Repayment Calculator | MCB	" />
        <meta
          name="description"
          content="Estimate your monthly loan repayments based on the representative APR, considering personal circumstances, loan amount, and term."
        />
        <title>Monthly Repayment Calculator | MCB</title>
        <meta
          property="og:title"
          content="Monthly Repayment Calculator | MCB"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://mcb.mu/tools-calculators/monthly-repayment"
        />
        <link rel="canonical" href="/monthly-repayment" />
      </Helmet>
          ...
          >
            <div className="row" data-sf-element="Row">
              ...
              >
                ...
                <div className="monthly-repayment-calculator">
                  <div className="row py-4">
                    <div className="col-lg-7">
                      ...
                      <p className="mb-4">
                        Estimate how much your monthly loan repayments may be.
                      </p>
                      <p className="mb-4">
      ...
      {/* Mirrored from mcb.mu/tools-calculators/monthly-repayment/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:55:17 GMT */}
    </>
  );
};
