...
const Coperate = () => {
  return (
    <>
      ...
      />
      <title>Corporate Banking | MCB</title>
      <meta property="og:title" content="Corporate Banking | MCB" />
      <meta
        ...
        <div role="main" className="main">
                    ...
                    <div className="row align-items-center h-100">
                      <div className="col pb-4">
                        ...
                        <div className="description">
                          <p>
                            We have the perfect financial solutions to help
                            seize perfect opportunities.&nbsp;
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="row" data-sf-element="Row">
            <div
              ...
              data-placeholder-label="Column 1"
            >
              <section className="img-text-cta card-cta-inverse">
                        ...
                        >
                          <span className="thumb-info-title bg-transparent">
                            <h3 className="card-title mb-4 text-6 font-weight-medium text-light w-50 w-100-mobile">
                              Rated the No. 1 Bank in Mauritius
                            </h3>
                            <p className="card-text font-weight-medium text-light w-75 w-100-mobile">
                              The Bank has been awarded by numerous regional and
                              international publications for its innovative
                              product offerings, business model and customer
                              service.
                            </p>
                            <a
          ...
          <div className="row" data-sf-element="Row">
            ...
            >
              ...
              >
                <div className="row corporate-block-ad" data-sf-element="Row">
                  <div
                    id="Main_C006_Col00"
                            ...
                            <span className="thumb-info border-all thumb-info-show-button-hover">
                              ...
                              >
                                <span className="thumb-info-title bg-transparent">
                                  ...
                                  <p className="card-text font-weight-medium text-light w-75 w-100-mobile">
                                    Experience in the Oil &amp; Gas industry to
                ...
                <div className="row" data-sf-element="Row">
                  ...
                  >
                    <div className="check-ul-styling">
                      <div>
                        <h2>Useful tools &amp; calculators</h2>
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <div className="card-body" data-mh-l1="tiles-block">
                            <div className="d-flex flex-column align-items-start">
                              ...
                              <p className="card-text line-height-5 mt-2">
                                Need to know your IBAN for a transfer? Simply
                                enter your bank account on our IBAN generator
                                and you&#39;re done!
                              </p>
                            </div>
                        ...
                        <div className="card bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
                          <div className="card-body" data-mh-l1="tiles-block">
                            <div className="d-flex flex-column align-items-start">
                              ...
                              <p className="card-text line-height-5 mt-2">
                                Looking for banking services? Submit a request
                                for proposal to MCB
                              </p>
                            </div>
                            <div className="d-flex flex-column align-items-end">
                        ...
                        <div className="card bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
                          <div className="card-body" data-mh-l1="tiles-block">
                            <div className="d-flex flex-column align-items-start">
                              ...
                              <p className="card-text line-height-5 mt-2">
                                A simplified and enhanced digital banking
                                experience awaits our non-individual customers
                              </p>
                            </div>
                            <div className="d-flex flex-column align-items-end">
                              <p className="mb-0 mt-3">
              ...
              <div className="check-ul-styling">
                <div>
                  <section
                    ...
                    style={{
                      borderTop: "1px solid rgba(246, 246, 246, 1)",
                      borderRight: "none",
                      borderBottom: "none",
                      borderLeft: "none",
      ...
      {/* Mirrored from mcb.mu/corporate by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:45:04 GMT */}
    </>
  );
};
