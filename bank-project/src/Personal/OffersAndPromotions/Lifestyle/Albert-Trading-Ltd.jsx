...
const AlbertTradingLtd = () => {
  const navItems = [
    ...
    { text: "Home Offers", href: "/personal/" },
  ...
  return (
    <>
      <meta name="title" content="Albert Trading Ltd" />
      <meta
        name="description"
        content='<p><strong>Up to 5% discountï¿½</strong><strong>:ï¿½</strong> Not applicable on promotional items.</p><br><p><strong>Applicable</strong> : To MCB Juice Users &amp; MCB Cardholders.</p><br><p><strong>Contact:</strong>ï¿½</p><ul class=""><li><span class=""></span><span class="">All Albert Trading Outlets | T: 208 0199</span></li></ul>'
      />
      <title>Albert Trading Ltd</title>
      <meta property="og:title" content="Albert Trading Ltd" />
      <meta
      ...
      <meta
        property="og:url"
        content="https://mcb.mu/personal/offers-and-promotions/Lifestyle/Albert-Trading-Ltd"
      />
      <meta property="og:site_name" content="MCB Mauritius" />
      <link rel="canonical" href="/Albert-Trading-Ltd" />
                  ...
                  <div className="tab-content">
                    ...
                    >
                      <div className="text-start">
                        <h4>Description</h4>
                        <p>
                          <strong>Up to 5% discountï¿½</strong>
                          <strong>:ï¿½</strong> Not applicable on promotional
                          items.
                        </p>
                        <br />
                        <p>
                          <strong>Applicable</strong> : To MCB Juice Users &amp;
                          MCB Cardholders.
                        </p>
                        <br />
                        <p>
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              All Albert Trading Outlets | T: 208 0199
                            </span>
                          </li>
                        </ul>
                        <p>
                          <strong>Validity:</strong> Thursday, 30 November 2023
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* Mirrored from mcb.mu/personal/offers-and-promotions/Lifestyle/Albert-Trading-Ltd by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:23:40 GMT */}
    </>
  );
};
export default AlbertTradingLtd;
