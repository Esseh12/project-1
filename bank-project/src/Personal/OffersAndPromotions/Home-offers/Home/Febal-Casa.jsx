...
const FebalCasa = () => {
  ...
  return (
    <>
      {/* Mirrored from mcb.mu/personal/offers-and-promotions/home-offers/Home/Febal-Casa by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:56:22 GMT */}
      <meta name="title" content="Febal Casa" />
      <meta
        name="description"
        content='<p><strong>15%</strong> discount on all products.</p><p><strong><br><br>Contact:</strong></p><ul class=""><li><span class=""></span><span class="">No. 1, Barracks Street, Port Louis | T: 210 6139</span></li></ul><p>ï¿½ ï¿½</p><div><p><strong>Conditions:</strong></p><ul class=""><li><span class=""></span><span class="">The offer is not applicable on any other promotion or discount and on partner products. Terms &amp; Conditions available in-store.</span></li></ul><div>ï¿½ ï¿½</div></div>'
      />
      <title>Febal Casa</title>
      <meta property="og:title" content="Febal Casa" />
      <meta
      ...
      <meta
        property="og:url"
        content="https://mcb.mu/personal/offers-and-promotions/home-offers/Home/Febal-Casa"
      />
      <link rel="canonical" href="/Febal-Casa" />
                  ...
                  <div className="tab-content">
                    ...
                    >
                      <div className="text-start">
                        <h4>Description</h4>
                        <p>
                          <strong>15%</strong> discount on all products.
                        </p>
                        <p>
                          <strong>
                            <br />
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              No. 1, Barracks Street, Port Louis | T: 210 6139
                            </span>
                          </li>
                        </ul>
                        <p>ï¿½ ï¿½</p>
                        <div>
                          ...
                          <ul className="">
                            <li>
                              <span className="" />
                              <span className="">
                                The offer is not applicable on any other
                                promotion or discount and on partner products.
                                Terms &amp; Conditions available in-store.
                              </span>
                            </li>
                          </ul>
                          <div>ï¿½ ï¿½</div>
