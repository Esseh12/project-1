                  ...
                  <div className="tab-content">
                    ...
                    >
                      <div className="text-start">
                        <h4>Description</h4>
                        <p>
                          Enjoy the following offers upon confirmation of
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              Salt chlorinator and cleaning equipment
                            </span>
                          </li>
                          <li>
                            <span className="" />
                            <span className="">
                              3 months of preventive maintenance
                            </span>
                          </li>
                          <li>
                            <span className="" />
                            <span className="">
                              6 months extension on equipment guarantee
                            </span>
                          </li>
                        </ul>
                        <div>
                          ...
                          <ul className="">
                            <li>
                              <span className="" />
                              <span className="">
                                Morcellement Majo, La Balise, Black River | T:
                                484 0390
                              </span>
                            </li>
                          </ul>
