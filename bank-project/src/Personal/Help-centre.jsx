...
const HelpCentre = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/personal/help-centre by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:38:34 GMT */}
        <meta name="title" content="Help Centre | MCB" />
        <meta name="description" />
        <title>Help Centre | MCB</title>
        <meta property="og:title" content="Help Centre | MCB" />
        <meta property="og:url" content="https://mcb.mu/personal/help-centre" />
        <link rel="canonical" href="/help-centre" />
      </Helmet>
      <div className="body detail-landing">
        ...
        <div role="main" className="main">
          <section
            ...
            style={{
              backgroundImage:
                "url(/images/mcb/personal/banners/personal-help-centre-bannerbe91.jpeg?sfvrsn=9eea8577_0)",
            }}
          >
              ...
              <div className="row d-flex">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#ffffff" }}
                  >
                    Your resource to guide you through frequently asked
                    questions and popular queries.
                  </p>
                </div>
            ...
            <div className="row" data-sf-element="Row">
              ...
              >
                <div className="check-ul-styling">
                  <div>
                    <p>
                      With help by category, it&#39;s easy for you to find
                      answers to your queries. We have gathered the most popular
                      questions and made available some handy videos to get you
                      started. Our calculators and tools can help you make
                    ...
                    <div className="card bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
                      ...
                      >
                        ...
                        <div className="d-flex flex-column align-items-end">
                          <p className="mb-0 mt-3">
                            <a
                              href="/personal/help-centre/how-to-videos"
                              target="_self"
                              className="read-more text-color-primary font-weight-semibold mt-2 text-2"
                            >
                              View videos
                    ...
                    <div className="card bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
                      ...
                      >
                        ...
                        <div className="d-flex flex-column align-items-end">
                          <p className="mb-0 mt-3">
                            <a
                              href="/personal/help-centre/tools-and-calculators"
                              target="_self"
                              className="read-more text-color-primary font-weight-semibold mt-2 text-2"
                            >
                              Discover
      ...
      {/* Mirrored from mcb.mu/personal/help-centre by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:38:38 GMT */}
    </>
  );
};
