...
const LoginToInternetBanking = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/personal/existing-customers/log-in-to-internet-banking by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:37:39 GMT */}
      ...
      <div className="container">
        ...
        <h3>
          You are being redirected to https://ib.mcb.mu/ This site is out of our
          control.
        </h3>
        <p>
          For your safety never enter your password for <b>https://mcb.mu/</b>{" "}
          on this site <b>https://ib.mcb.mu</b>.
        </p>
        <p>
          Be warned that any time you see this message you may be heading to a
          non-trusted site. Untrusted sites may contain malware or may imitate
          the design of other sites in attempt to deceit you to give away
          credentials, personal or financial information.
        </p>
        <div className="btn-area">
          <a className="btn btn-primary" href="/">
            Go to homepage
          </a>
          <a href="/T001/banking.html">Proceed to https://ib.mcb.mu/</a>
        </div>
      </div>
      {/* Mirrored from mcb.mu/personal/existing-customers/log-in-to-internet-banking by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:37:39 GMT */}
    </>
...
export default LoginToInternetBanking;
