...
const AssociatedTextileServices = () => {
  const navItems = [
    {
          ...
          <div className="container locate-us-block">
            <div className="row ">
              <div className="col-lg-12">
                <h1>Associated Textile Services</h1>
              </div>
            </div>
          </div>
                  ...
                  <div className="tab-content">
                    ...
                    >
                      <div className="text-start">
                        <h4>Description</h4>
                        <p>
                          <strong>5%</strong> discount on normal price products
                          in shops only.
                        </p>
                        <br />
                        <p>
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              Zone Industrielle, St Pierre | T: 433 5050
                            </span>
                          </li>
                          <li>
                            <span className="" />
                            <span className="">
                              Cap Dal, Tamarin | T: 483 7328
                            </span>
                          </li>
                          <li>
                            <span className="" />
                            <span className="">
                              Circle Square, Forbach | T: 244 3044
                            </span>
                          </li>
                        </ul>
                        <div>ï¿½ ï¿½</div>
...
export default AssociatedTextileServices;
