...
const EntrepoDeLaPierre = () => {
  ...
  return (
    <>
      {/* Mirrored from mcb.mu/personal/offers-and-promotions/home-offers/Home/Entrepot-de-la-Pierre by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:56:11 GMT */}
      <meta name="title" content="Entrep&#244;t de la Pierre" />
      <meta
        name="description"
        content='<p>Enjoy <strong>15%</strong> discount on any product purchased.</p><p>Conditions apply.</p><br><p><strong>Contact</strong></p><ul class=""><li><span class=""></span><span class="">Corner St Vincent de Paul &amp; Jackaria Street, Pailles | T: 286 3154</span></li></ul><p>ï¿½ ï¿½</p>'
      />
      <title>Entrepôt de la Pierre</title>
      <meta property="og:title" content="Entrepôt de la Pierre" />
      <meta
      ...
      <meta
        property="og:url"
        content="https://mcb.mu/personal/offers-and-promotions/home-offers/Home/Entrepot-de-la-Pierre"
      />
      <meta property="og:site_name" content="MCB Mauritius" />
      <link rel="canonical" href="/Entrepot-de-la-Pierre" />
                  ...
                  <div className="tab-content">
                    ...
                    >
                      <div className="text-start">
                        <h4>Description</h4>
                        <p>
                          Enjoy <strong>15%</strong> discount on any product
                          purchased.
                        </p>
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              Corner St Vincent de Paul &amp; Jackaria Street,
                              Pailles | T: 286 3154
                            </span>
                          </li>
                        </ul>
...
export default EntrepoDeLaPierre;
