...
const VhHomeDecorations = () => {
  ...
  return (
    <>
      {/* Mirrored from mcb.mu/personal/offers-and-promotions/home-offers/Home/VH-Home-Decorations by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:56:11 GMT */}
      <meta name="title" content="VH Home Decorations" />
      <meta
        name="description"
        content='<p><strong>5%</strong> discount.</p><br><p><strong>Contact:</strong>ï¿½</p><ul class=""><li><span class=""></span><span class="">Franï¿½ois Leguat Street, Port Mathurin, Rodrigues | T: 5920 0049</span></li></ul><div>ï¿½ ï¿½</div>'
      />
      <title>VH Home Decorations</title>
      <meta property="og:title" content="VH Home Decorations" />
      <meta
      ...
      <meta
        property="og:url"
        content="https://mcb.mu/personal/offers-and-promotions/home-offers/Home/VH-Home-Decorations"
      />
      <link rel="canonical" href="VH-Home-Decorations" />
  ...
  height="0" width="0" style="display:none;visibility:hidden"></iframe>`,
                      ...
                      <div className="text-start">
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              Franï¿½ois Leguat Street, Port Mathurin, Rodrigues
                              | T: 5920 0049
                            </span>
                          </li>
                        </ul>
      ...
      {/* Mirrored from mcb.mu/personal/offers-and-promotions/home-offers/Home/VH-Home-Decorations by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:56:12 GMT */}
    </>
  );
};
export default VhHomeDecorations;
