...
const RaisonHome = () => {
  ...
  return (
    <>
      {/* Mirrored from mcb.mu/personal/offers-and-promotions/home-offers/Home/RAISON-HOME by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 09:56:11 GMT */}
      <meta name="title" content="RAISON HOME" />
      <meta
        name="description"
        content='<p><strong>15%</strong> discount on normal price only.</p><br><p><strong>Condition:</strong></p><ul class=""><li><span class=""></span><span class="">The offer cannot be combined with any promotion or discount.</span></li></ul><br><p><strong>Contact:</strong></p><ul class=""><li><span class=""></span><span class="">Morcellement Mont Choisy, Mont Choisy | T: 5973 6872 / 5977 9804</span></li></ul><div>ï¿½ ï¿½</div>'
      />
      <title>RAISON HOME</title>{" "}
      <meta property="og:title" content="RAISON HOME" />
      <meta
      ...
      <meta
        property="og:url"
        content="https://mcb.mu/personal/offers-and-promotions/home-offers/Home/RAISON-HOME"
      />
      <meta property="og:site_name" content="MCB Mauritius" />
      <link rel="canonical" href="RAISON-HOME" />
                  ...
                  <div className="tab-content">
                    ...
                    >
                      <div className="text-start">
                        <h4>Description</h4>
                        <p>
                          <strong>15%</strong> discount on normal price only.
                        </p>
                        <br />
                        <p>
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              The offer cannot be combined with any promotion or
                              discount.
                            </span>
                          </li>
                        </ul>
                        ...
                        <ul className="">
                          <li>
                            <span className="" />
                            <span className="">
                              Morcellement Mont Choisy, Mont Choisy | T: 5973
                              6872 / 5977 9804
                            </span>
                          </li>
                        </ul>
