...
const OverdraftsWorkingCapitals = () => {
  return (
    <>
      <Helmet>
        {/* Mirrored from mcb.mu/corporate/finance-lending/corporate-lending/overdraft-working-capital by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 06:50:58 GMT */}
        <meta
          name="title"
          content="Overdraft &amp; Working Capital | Corporate Banking | MCB	"
        />
        <meta
          name="description"
          content="Improve your cash flow with a short-term credit facility in times of unexpected demands or temporary financing needs to keep on funding your business growth."
        />
        <title>Overdraft &amp; Working Capital | Corporate Banking | MCB</title>
        <meta
          property="og:title"
          content="Overdraft & Working Capital | Corporate Banking | MCB"
        />
              ...
              <div className="row d-flex">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#ffffff" }}
                  >
                    Improve your cash flow with a short-term credit facility in
                    times of unexpected demands or temporary financing needs to
                    keep on funding your business growth.
                  </p>
                </div>
            ...
            >
              ...
              >
                <div className="check-ul-styling">
                  <div>
                    <h2>A flexible safety net to ease your cash flow</h2>
                    <p>
                      Access immediate financing to manage your cash
                      fluctuations through your dedicated Relationship Manager
                      who will provide you individually tailored solutions to
                      meet your specific business and your trade needs.
                    </p>
                    <h3>
                      <br />
                    ...
                    <p>
                      Leverage the expertise of our corporate banking
                      specialists who will provide you flexible overdrafts to
                      boost your cash flow or respond to your company’s working
                      capital requirements. Access our flexible, convenient
                      overdraft facility whenever your business needs a
                      short-term credit facility to ease your cash flow.
                    </p>
                    <ul>
                      <li>
                        A dedicated Relationship Manager who provides you with a
                      ...
                      <li>
                        Flexible funding to cover short-term needs and easy to
                        arrange
                      </li>
                      <li>
                        Boost your company’s cash flow by securing funding to
                        grow your business
                      </li>
                    </ul>
                  </div>
...
export default OverdraftsWorkingCapitals;
